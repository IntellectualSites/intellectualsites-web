  ...
  <main class="container mx-auto px-6">
    <div class="py-8">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p
          class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl h-20 text-center lg:mb-6 mb-12"
        >
              ...
              <div class="shadow sm:rounded-md">
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <div class="bg-red-500 text-white rounded-lg p-3 text-sm">
                    ...
                    <br />
                    Versions labeled as "Spigot" run on PaperMC as well.
                    <br />
                    Versions below 1.16.5 are classified as legacy and receive no support.
                  </div>
        ...
        <!--            <div class="text-center">-->
        <!--              <p-->
        <!--                  class="mt-2 text-xl leading-8 font-bold tracking-tight text-gray-900 sm:text-2xl"-->
        <!--              >-->
        <!--                Download {{ name }}-->
        <!--              </p>-->
        <!--            </div>-->
        ...
        <!--              </p>-->
        <!--              <RouterLink-->
        <!--                  v-for="dependency in optionalDependencies" v-bind:key="dependency.title"-->
        <!--                  :to="`/${dependency.url}`"-->
        <!--                  type="button"-->
        <!--                  class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mt-2"-->
        <!--              >-->
        <!--                {{ dependency.title }}-->
        <!--              </RouterLink>-->
        <!--            </div>-->
